 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.emfstore.fuzzy.emfdataprovider.config.impl.TestResultImpl#getSeedCount <em>Seed Count</em>}</li>
 *   <li>{@link org.eclipse.emf.emfstore.fuzzy.emfdataprovider.config.impl.TestResultImpl#getTestName <em>Test Name</em>}</li>
 *   <li>{@link org.eclipse.emf.emfstore.fuzzy.emfdataprovider.config.impl.TestResultImpl#getError <em>Error</em>}</li>
 *   <li>{@link org.eclipse.emf.emfstore.fuzzy.emfdataprovider.config.impl.TestResultImpl#getFailure <em>Failure</em>}</li>
 *   <li>{@link org.eclipse.emf.emfstore.fuzzy.emfdataprovider.config.impl.TestResultImpl#getExecutionTime <em>Execution Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestResultImpl extends EObjectImpl implements TestResult {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConfigPackage.TEST_RESULT__SEED_COUNT:
				return new Integer(getSeedCount());
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ConfigPackage.TEST_RESULT__SEED_COUNT:
				setSeedCount(((Integer)newValue).intValue());
				return;
			case ConfigPackage.TEST_RESULT__TEST_NAME:
