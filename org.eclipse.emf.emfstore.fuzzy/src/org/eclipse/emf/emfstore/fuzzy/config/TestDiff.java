 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.emfstore.fuzzy.config.TestDiff#getLastUpdate <em>Last Update</em>}</li>
 *   <li>{@link org.eclipse.emf.emfstore.fuzzy.config.TestDiff#getConfig <em>Config</em>}</li>
 *   <li>{@link org.eclipse.emf.emfstore.fuzzy.config.TestDiff#getOldResult <em>Old Result</em>}</li>
 *   <li>{@link org.eclipse.emf.emfstore.fuzzy.config.TestDiff#getNewResult <em>New Result</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.emf.emfstore.fuzzy.config.ConfigPackage#getTestDiff()
 * @model
 * @generated
 */
public interface TestDiff extends EObject {
	 ...
	 * @see org.eclipse.emf.emfstore.fuzzy.config.ConfigPackage#getTestDiff_LastUpdate()
	 * @model
	 * @generated
	 */
	Date getLastUpdate();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.fuzzy.config.TestDiff#getLastUpdate <em>Last Update</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.emf.emfstore.fuzzy.config.ConfigPackage#getTestDiff_Config()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.fuzzy.config.TestDiff#getConfig <em>Config</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
